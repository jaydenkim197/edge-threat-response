...
| 공개 source 역할·admission policy | 공식 source page/paper desk review와 target-domain 기준 문서화 | 개발 PC, 2026-09-22 | 약 3 m fixed/elevated indoor CCTV 기준과 training/holdout/synthetic 역할 분리 | `docs/dataset-source-strategy.md` | policy `DECISION`; raw package·license·sample/dedup audit `PLANNED` |
