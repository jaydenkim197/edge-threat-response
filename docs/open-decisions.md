...
| P0-10 | P0 | 외부 dataset recipe | target domain은 약 3 m 고정형 indoor elevated CCTV로 `DECISION`. SOHAS=첫 public real-data 후보, DaSCI=중복 확인 뒤 보강 후보, ACF/Mock Attack=초기 training 제외·external CCTV holdout 후보, Simuletic=별도 synthetic ablation 한정. 실제 채택·recipe는 registry·sample 검수 후 승인 | small/distant knife, person 동시 annotation, CCTV domain, negatives, license, exact/perceptual duplicate, camera/session leakage | D2 import 전 | `PROPOSAL` |
